...
if(udd != null){out.print(udd.getName());}
      out.write("\">\n");
      out.write("        <br><br>\n");
      out.write("\n");
      out.write("        生年月日:　\n");
 ...
 for(int i=1950; i<=2010; i++){ 
      ...
      out.write('"');
      out.write(' ');
 if(udd.getYear(udd.getBirthday()) == i){out.print("selected = \"selected\"");}
      out.write('>');
      out.print(i);
      out.write("</option>\n");
      out.write("            ");
 ...
 for(int i = 1; i<=12; i++){ 
      ...
      out.write('"');
      out.write(' ');
 if(udd.getMonth(udd.getBirthday()) == i){out.print("selected = \"selected\"");}
      out.write('>');
      out.print(i);
      out.write("</option>\n");
      out.write("            ");
 ...
 for(int i = 1; i<=31; i++){ 
      ...
      out.print(i);
      out.write('"');
 if(udd.getDay(udd.getBirthday()) == i){out.print("selected = \"selected\"");}
      out.write('>');
      out.print(i);
      out.write("</option>\n");
      out.write("            ");
...
if(udd.getType() == i){out.print("checked = \"checked\"");}
      ...
      out.write("\">\n");
      out.write("        <input type=\"hidden\" name=\"paramID\" value=\"");
      ...
      out.print(udd.getUserID());
      out.write("\">\n");
      out.write("            <input type=\"submit\" name=\"btnSubmit\" value=\"詳細画面へ戻る\"><br>\n");
      out.write("        </form>\n");
      out.write("        <br>\n");
      out.write("        ");
      out.print(jh.home());

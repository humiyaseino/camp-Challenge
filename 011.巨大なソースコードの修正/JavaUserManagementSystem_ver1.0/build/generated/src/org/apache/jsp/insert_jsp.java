...
if (hs.getAttribute("year") != null){out.print(hs.getAttribute("year"));}else{out.print("----");}
      out.write("</option>\n");
      out.write("            ");
      ...
      out.write("            <option value=\"\">");
if (hs.getAttribute("month") != null){out.print(hs.getAttribute("month"));}else{out.print("--");}
      out.write("</option>\n");
      out.write("            ");
      ...
      out.write("            <option value=\"\">");
if (hs.getAttribute("day") != null){out.print(hs.getAttribute("day"));}else{out.print("--");}
      out.write("</option>\n");
      out.write("            ");
...
if (hs.getAttribute("type") != null && hs.getAttribute("type").equals("2")){
      out.write("checked");
}
      out.write(">営業<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"3\"");
if (hs.getAttribute("type") != null && hs.getAttribute("type").equals("3")){
      out.write("checked");
}
      out.write(">その他<br>\n");
      out.write("        <br>\n");
